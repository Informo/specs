...
Client implementations **can** also compute the "trust distance" of a source or TA, i.e. the length of the shortest path between the source or TA and a trusted TA. This distance **can** be used to estimate how much a source or TA is reliable, and entities with the lowest values **can** be promoted to the user.
